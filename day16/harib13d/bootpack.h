...
struct TASKLEVEL {
	int running; /* the number of running task */
	int now; /* to recode the running task now */
	struct TASK *tasks[MAX_TASKS_LV];
};

struct TASKCTL {
	int now_lv; /* active LEVEL */
	char lv_change; /* if need to chang the LEVEL when task switch next time */
